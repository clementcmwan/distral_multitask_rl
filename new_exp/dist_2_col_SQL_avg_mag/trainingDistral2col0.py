...
def trainD(file_name="Distral_2col", list_of_envs=[GridworldEnv(5),
    ...
    np.save(file_name + '-distilled_logit_norms', distilled_logits_magnitude)
    np.save(file_name + '-policy_logit_norms', policy_logits_magnitude)
...
if __name__ == '__main__':
    ...
    trainD(list_of_envs=[GridworldEnv(4),GridworldEnv(5),GridworldEnv(6),GridworldEnv(7),GridworldEnv(8)], learning_rate=0.001, num_episodes=200)
    # trainD(list_of_envs=[GridworldEnv(4),GridworldEnv(5)], learning_rate=0.001, num_episodes=200)